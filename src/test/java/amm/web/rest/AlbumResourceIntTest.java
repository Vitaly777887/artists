...
import amm.repository.AlbumRepository;
...
public class AlbumResourceIntTest {
    ...
    private static final Integer DEFAULT_COUNT_SONGS = 1;
    private static final Integer UPDATED_COUNT_SONGS = 2;
    ...
    public static Album createEntity(EntityManager em) {
        Album album = new Album()
            .title(DEFAULT_TITLE)
            .year(DEFAULT_YEAR)
            .countSongs(DEFAULT_COUNT_SONGS);
        return album;
    }
    ...
    public void createAlbum() throws Exception {
        ...
        assertThat(testAlbum.getCountSongs()).isEqualTo(DEFAULT_COUNT_SONGS);
    }
    ...
    @Test
    @Transactional
    public void checkCountSongsIsRequired() throws Exception {
        int databaseSizeBeforeTest = albumRepository.findAll().size();
        // set the field null
        album.setCountSongs(null);
    ...
    public void getAllAlbums() throws Exception {
        ...
        restAlbumMockMvc.perform(get("/api/albums?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].countSongs").value(hasItem(DEFAULT_COUNT_SONGS)));
    }
    ...
    public void getAlbum() throws Exception {
        ...
        restAlbumMockMvc.perform(get("/api/albums/{id}", album.getId()))
            ...
            .andExpect(jsonPath("$.countSongs").value(DEFAULT_COUNT_SONGS));
    }
    ...
    public void updateAlbum() throws Exception {
        ...
        updatedAlbum
            .title(UPDATED_TITLE)
            .year(UPDATED_YEAR)
            .countSongs(UPDATED_COUNT_SONGS);
        ...
        assertThat(testAlbum.getCountSongs()).isEqualTo(UPDATED_COUNT_SONGS);
    }
