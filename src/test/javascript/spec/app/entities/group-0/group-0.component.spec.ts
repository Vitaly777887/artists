...
import { Group0Component } from 'app/entities/group-0/group-0.component';
import { Group0Service } from 'app/entities/group-0/group-0.service';
import { Group0 } from 'app/shared/model/group-0.model';

describe('Component Tests', () => {
    describe('Group0 Management Component', () => {
        let comp: Group0Component;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(Group0Component, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.group0S[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
